...
(62, 4, 'Tesla Model S', 'Tesla Model S là một chiếc xe sang chạy hoàn toàn bằng điện hiệu suất cao đã định nghĩa lại những gì xe điện có thể làm. \r\nRa mắt vào năm 2012, mẫu xe này kết hợp thiết kế đẹp mắt, công nghệ tiên tiến và phạm vi hoạt động ấn tượng, khiến nó trở thành một trong những chiếc xe điện tiên tiến nhất trên thị trường.', 2415000000.00, 'uploads/1745326851_download (9).jfif', 'selling', 0, 0, 322.00, 'Trắng ngọc trai đa lớp, đen trơn, bạc Midnight', 'Hệ truyền động điện 2 hoặc 3 mô-tơ dẫn động bốn bánh', '2012', 5, 'Điện', 999.00, NULL, 'TPHCM', NULL, '100 kWh'),
