...
session_start();
 $username=isset($_SESSION['username']) ? htmlspecialchars($_SESSION['username']) : '' ;
    ...
    $address=isset($_SESSION['address']) ? htmlspecialchars($_SESSION['address']) : '' ; $role=isset($_SESSION['role'])
    ? htmlspecialchars($_SESSION['role']) : '' ; if (isset($_POST["logout"])) { session_destroy(); session_start();
    $_SESSION['logout_message']="Bạn đã đăng xuất thành công." ; header("Location: login.php"); exit(); } // Add thisnew variable for first login check
     $showLoginNotification=false; 
    if (isset($_SESSION['first_login']) &&$_SESSION['first_login']===true) 
    { 
        $showLoginNotification=true; $_SESSION['first_login']=false; // Reset the flag 
        }
    include 'connect.php' ; 
    ?>
        ...
        <div class="login-register-ctn">
            <div class="login-register">
                ...
                <?php else: ?>
                    <!-- Not logged in state -->
                    <div class="notlogin">
                        <a href="cart.php" class="auth-link"><i class="fa-solid fa-cart-shopping"></i>Giỏ hàng của tôi</a>
