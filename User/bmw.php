...
<style>
    ...
    main {
        padding: 0 !important;
        /* Force override any other padding */
        margin: 0;
    }
...
<body>
    ...
    <main>
        <div class="bmw-content">
            ...
            <h1
                style="text-align: center;background-image: url('joyful_christmas_drive_1920x1080.webp');min-height: 100vh;padding: 50px;color: rgb(255, 255, 255);font-weight: normal;">
                BMW - Bayerische Motoren Werke AG</h1>
            <div id="newcar">
